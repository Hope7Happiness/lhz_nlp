...
from transformers.models.llama.modeling_llama import LlamaAttention, LlamaForCausalLM, LlamaMLP, LlamaDecoderLayer
...
class HybridMixerModel(nn.Module):
    def __init__(
        self,
        d_model: int,
        n_layer: int,
...
class HybridMambaLMHeadModel(nn.Module, GenerationMixin):
    ...
    def __init__(
        ...
        self.backbone = HybridMixerModel(
            d_model=d_model,
            n_layer=n_layer,
