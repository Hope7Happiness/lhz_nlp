...
# 1
python ~/staging.py --exe TODO --remote_url satori_xibo --remote_stage_dir /nobackup/users/jzc_2007/staging --task_name LHZ_NLP_gendata --gpus 1 --time 8:00:00 --exclusive --conda_env LYY
